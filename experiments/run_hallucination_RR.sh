...
HALL_ROOT=/home/rmfrieske/datasets/${EXPERIMENT}/
...
#   --config-yaml config.yaml --train-subset train-RR_20 --valid-subset dev-clean,dev-other \
...
if ! ${CHECKPOINT_DIR}/${CHECKPOINT_FILENAME} ; then
python ${FAIRSEQ}/scripts/average_checkpoints.py --inputs ${CHECKPOINT_DIR} \
  --num-epoch-checkpoints 10 \
  --output "${CHECKPOINT_DIR}${CHECKPOINT_FILENAME}"
fi
